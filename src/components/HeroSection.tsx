        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-8 opacity-0 animate-fade-up" style={{ animationDelay: "800ms" }}>
              <a
                href="#contact"
                className="relative overflow-hidden inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground font-body font-semibold text-[15px] px-8 py-4 rounded-pill shadow-card-brand shimmer-btn hover:shadow-hover-brand hover:scale-[1.02] transition-all duration-300 active:scale-[0.98] group"
              >
              ...
              {[
                ...
                <div key={t} className="flex items-center gap-2">
                  <CheckCircle2
                    ...
                    style={{ strokeDasharray: 60, strokeDashoffset: 60, animation: `draw-check 0.6s ease-out ${i * 200 + 1000}ms forwards` }}
                  />
